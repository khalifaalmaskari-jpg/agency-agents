...
| 🧾 [Resume Tailor](specialized/resume-tailor.md) | Resume optimization, ATS alignment, job application positioning | Tailoring resumes to specific roles without fabricating experience |
